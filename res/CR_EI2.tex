...
\begin{itemize}
    ...
    \item \textbf{Répétitions :} 3 fois par instance avec un alpha différent à chaque fois.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{doc/GRASP.png}
  \caption{Z\_mean.}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{doc/ReactiveGRASP.png}
  \caption{Z\_mean.}
\end{figure}
...
\begin{itemize}
  ...
  \item Les $\alpha$ de 0.9 sont dans notre expérimentation les plus performantes sur la majorité des instances et sont sans concurrence sur les grandes instances.
\end{itemize}
...
car il réalise souvent plus d'itérations que celle fixée dans ma première expérimentation surtout quand les instances sont petites. Pour finir j'ai pu constater que les valeurs de $\alpha$ les plus élevées sont celles qui donnent les meilleurs résultats dans la majorité des cas.
